...
3. Download npm dependencies by typing `npm install` in your Command Line Interface. This application uses the mysql2, inquirer, console.table, and synchronized-promise npm packages.
